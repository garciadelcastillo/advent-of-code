...
const initialState = {
  turn: 0,
  player_hits: 50 - 1,  // we remove the one hit here to kickstart 
  player_mana: 500,
  player_armor: 0,
  boss_hits: 58,
  boss_damage: 9,
...
const distill_best_game = () => {
  ...
  // if (pending_states.length > 0) console.log("Most recent:", pending_states[pending_states.length - 1].history);
  console.log();
}
...
if (!best_game) distill_best_game();
...
// PART II
// Interestingly, this one ran in a split second! 1309 for [3, 4, 2, 3, 4, 2, 3, 0, 0]