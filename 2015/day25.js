...
const computeId = (row, col) => {
  if (row == 1 && col == 1) return 0;

  // Which diagonal is the value at? 
  const diagId = row + col - 1;
  
  // First compute the triangular number
  // for all values above current diagonal:
  const triang_count = 0.5 * (diagId -1) * diagId

  // Add remainder 
  return triang_count + col - 1;
}
// console.log(computeId(1, 1));
// console.log(computeId(2, 1));
// console.log(computeId(1, 2));
// console.log(computeId(3, 1));
// console.log(computeId(2, 2));
// console.log(computeId(1, 3));


// These indices are 1-based
const input_row = 2981;
const input_col = 3075;
const input_index = computeId(input_row, input_col);
console.log("INPUT ROW:", input_row);
console.log("INPUT COL:", input_col);
console.log("INPUT Nth OBJECT:", input_index);  // ~18m !

// 
const start_val = 20151125;
const mult = 252533;
const mod = 33554393;

const computeValueAt = (row, col) => {
  const index = computeId(row, col);

  let total = start_val;
  for (let i = 0; i < index; i++) {
    total = (mult * total) % mod;    
  }
...
console.log(computeValueAt(1, 1) == 20151125)

// (2,3) should be 16929656
console.log(computeValueAt(2, 3) == 16929656)

// (5, 6) should be 31663883
console.log(computeValueAt(5, 6) == 31663883);


// BRUTEFORCE IT! 

let code = computeValueAt(input_row, input_col);
